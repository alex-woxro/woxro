...
import hamburger from '/public/assets/icons/navbar/hamburger.png'
...
const Navbar = () => {
  ...
  return (
    <div className={`z-[9999] fixed w-full ${color ? 'bg-black' : ''} 3xl:pl-16 3xl:pr-24 pt-5 px-5`}>
      <div className='flex justify-between items-center '>
        <Image src={logo} alt='woxro-logo' width={67} height={53} priority={true} />
        <div className='lg:flex gap-[84px] items-center hidden'>
        ...
        <div className='lg:hidden'>
          <Image src={hamburger} alt='hamburger' width={34} height={22} />
        </div>
