  ...
  return (
    <section>
      <div>
        <BackgroundGradientAnimation>
          <div className="absolute z-50 inset-0 pointer-events-none">
            ...
            <div className='px-5 flex lg:justify-center items-center h-screen m-auto'>
      ...
      <div>
        <BackgroundGradientAnimation>
          <div className="absolute z-50 inset-0 pointer-events-none">
            <div className='flex justify-center items-center h-screen border py-[250px]'>
              <div className='text-[30px] leading-[60px] lg:text-[40px] lg:leading-[65px] font-light font-ibmPlexSans w-[70%] m-auto'>
